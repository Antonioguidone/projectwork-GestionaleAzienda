...
import com.generation.italy.projectwork.security.Roles;
...
public class Utente implements UserDetails {
...

	{
		...
		AUTHORITIES.put(Roles.ROOT, Arrays.asList(new GrantedAuthority[] { new SimpleGrantedAuthority("ROLE_ROOT"),
